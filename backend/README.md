...
## Project Structure
    ...
    ├── tst_android_preview_10  # Django project configurations
...
1. Clone this repo and `cd tst_android_preview_10`
...
2. Clone this repo and `cd tst_android_preview_10`
